...
export default function LeaderboardPlaceSvg({ place, ...props }) {
  switch (place) {
    case 1: // svg pour la première place
      return (
        <svg width="41" height="42" viewBox="0 0 41 42" fill="none" {...props}>
          <path
    ...
    case 2: // svg pour la deuxième place
      return (
        <svg width="41" height="42" viewBox="0 0 41 42" fill="none" {...props}>
          <path
    ...
    case 3: // svg pour la troisième place
      return (
        <svg width="41" height="42" viewBox="0 0 41 42" fill="none" {...props}>
          <path
    ...
    default: // retourner un svg vide si la place n'est pas 1, 2 ou 3
      return <svg width="41" height="42" viewBox="0 0 41 42" fill="none"></svg>;
  }
};