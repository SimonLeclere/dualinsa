...
import imageQuestion from "/public/beaker.png";

// Type de question : 1 bonne réponse parmi n
export default function ProblemSelect1Ofn ({
  problem,
  correctAnswerCount,
  ...
  const { question, image, answers, correctAnswer } = problem;
            ...
            {answers.map((answer, i) => {
              return (
                <div
                  ...
                  className={
                    i === selectedAnswer
                      ? "cursor-pointer rounded-xl border-2 border-b-4 border-blue-300 bg-blue-100 p-6 text-blue-400"
                      : "cursor-pointer rounded-xl border-2 border-b-4 border-gray-200 p-6 hover:bg-gray-100"
                  }
                  role="radio"
